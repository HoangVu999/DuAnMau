        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
               aria-expanded="true" aria-controls="collapseTwo">
                ...
                <span>Danh sách trang: </span>
            </a>
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Quản trị trang:</h6>
                    <a class="collapse-item" href="<?= ROOT ?>admin/?page=product">Danh sách sản phẩm</a>
                    <a class="collapse-item" href="<?= ROOT ?>admin/?page=category">Danh mục</a>
                    <a class="collapse-item" href="<?= ROOT ?>admin/?page=user">Danh sách user</a>
                    <a class="collapse-item" href="<?= ROOT ?>admin/?page=comment">Danh sách Comment</a>
                    <a class="collapse-item" href="<?= ROOT ?>admin/?page=slider">Quản lý Slider</a>
                </div>
            </div>
        </li>
        <!-- Divider -->
